...
const ButtonPanel = () => (
  <div className="calculator_button">
    <div className="groupOne">
      <Button aria-label="AC" name="AC" className="tierOne" id="clear" />
      <Button aria-label="+/-" name="+/-" className="tierOne" id="plus_minus" />
      <Button aria-label="%" name="%" className="tierOne" id="percent" />
    ...
    <div className="groupFive">
      <Button aria-label="0" name="0" className="tierTwo" />
